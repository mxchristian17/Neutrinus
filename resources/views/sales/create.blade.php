...
<div class="container">
  ...
  {!! Form::open(['url' => '/storesale']) !!}
  <div class="input-group input-group-sm mt-1">
    <div class="input-group-prepend">
      <span class="input-group-text">Cliente</span>
    </div>
    {!! Form::select('client_id', $client_id, old('client_id'),['class'=>'form-control']) !!}
  </div>
  <div class="input-group input-group-sm mt-1">
    <div class="input-group-prepend">
      <span class="input-group-text">Estado</span>
    </div>
    {!! Form::select('status', $status, old('status'),array_merge(['class'=>'form-control'], ['onchange' => 'statusChange(this)'], ['id' => 'status_selector'])) !!}
  </div>
  <div class="input-group input-group-sm mt-1 bill_number">
    <div class="input-group-prepend">
      <span class="input-group-text">Número de factura</span>
    </div>
    {!! Form::text('bill_number', old('bill_number'), array_merge(['class' => 'form-control'], ['placeholder' => 'Número de factura...'])) !!}
  </div>
  <div class="input-group input-group-sm mt-1 order_number">
    <div class="input-group-prepend">
      <span class="input-group-text">Código de órden de compra</span>
    </div>
    {!! Form::text('order_number', old('order_number'), array_merge(['class' => 'form-control'], ['placeholder' => 'Código de órden de compra...'])) !!}
  </div>
  <div class="input-group input-group-sm mt-1 quoted_date">
    <div class="input-group-prepend">
      <span class="input-group-text">Fecha de cotización</span>
    </div>
    {!! Form::input('datetime-local', 'quoted_date', Carbon\Carbon::parse(today())->format('Y-m-d\TH:i'), ['class' => 'form-control']) !!}
  </div>
  <div class="input-group input-group-sm mt-1 purchase_order_reception_date">
    ...
    {!! Form::input('datetime-local', 'purchase_order_reception_date', Carbon\Carbon::parse(today())->format('Y-m-d\TH:i'), ['class' => 'form-control']) !!}
  </div>
  <div class="input-group input-group-sm mt-1 requested_delivery_date">
    ...
    {!! Form::input('datetime-local', 'requested_delivery_date', Carbon\Carbon::parse(today())->addDays(1)->format('Y-m-d\TH:i'), ['class' => 'form-control']) !!}
  </div>
  <div class="input-group input-group-sm mt-1 scheduled_delivery_date">
    ...
    {!! Form::input('datetime-local', 'scheduled_delivery_date', Carbon\Carbon::parse(today())->addDays(1)->format('Y-m-d\TH:i'), ['class' => 'form-control']) !!}
  </div>
  <div class="input-group input-group-sm mt-1 ready_to_deliver_date">
    ...
    {!! Form::input('datetime-local', 'ready_to_deliver_date', Carbon\Carbon::parse(today())->addDays(1)->format('Y-m-d\TH:i'), ['class' => 'form-control']) !!}
  </div>
  <div class="input-group input-group-sm mt-1 delivered_date">
    <div class="input-group-prepend">
      <span class="input-group-text">Fecha de entrega ejecutada</span>
    </div>
    {!! Form::input('datetime-local', 'delivered_date', Carbon\Carbon::parse(today())->addDays(1)->format('Y-m-d\TH:i'), ['class' => 'form-control']) !!}
  </div>
  ...
  <div class="input-group input-group-sm mt-1 retentions">
    ...
    {!! Form::number('retentions', old('retentions') ?? 0, array_merge(['class' => 'form-control'], ['step' => '0.01'], ['min' => '0'])) !!}
  </div>
  <div class="input-group input-group-sm mt-1 perceptions">
    <div class="input-group-prepend">
      <span class="input-group-text">Monto de percepciones</span>
    </div>
    {!! Form::number('perceptions', old('perceptions') ?? 0, array_merge(['class' => 'form-control'], ['step' => '0.01'], ['min' => '0'])) !!}
  </div>
  <div class="input-group input-group-sm mt-1">
    {!! Form::textarea('observations', old('observations'), array_merge(['class' => 'form-control'], ['placeholder' => 'Observaciones generales de la venta...'], ['style' => 'height:100px;'])) !!}
  </div>
  <div class="input-group input-group-sm mt-1">
    <div class="input-group-prepend">
