@extends('layouts.app')
@section('pageTitle'){{ "Editar cliente ".$client->name." -" }} @endsection
@section('scripts')
...
@section('content')
	...
	<div class="container">
		...
		<div class="input-group mt-1">
			{!! Form::select('taxpayer_type_id', $taxpayer_type_id, old($client->taxpayer_type_id),['class'=>'form-control']) !!}
			<div class="input-group-append">
		    <span class="input-group-text">Tipo de contribuyente</span>
		  </div>
		</div>
		<div class="input-group mt-1">
			{!! Form::select('currency_id', $currencies, old($client->currency_id),['class'=>'form-control']) !!}
			<div class="input-group-append">
		    <span class="input-group-text">Moneda de facturación</span>
		  </div>
		</div>
		<div class="input-group mt-1">
			{!! Form::select('state_id', $states, old($client->state_id),['class'=>'form-control']) !!}
			<div class="input-group-append">
		...
		<a class="btn btn-link" href="{{asset('/clients')}}">Volver</a>
		@if ($errors->any())
