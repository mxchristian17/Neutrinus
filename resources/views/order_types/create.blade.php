@extends('layouts.app')
@section('pageTitle'){{ "Crear tipo de pedido -" }} @endsection
@section('scripts')
...
@section('content')
	<div class="container">
		...
		@endif
		<h1 class="d-inline">Crear tipo de pedido</h1><a href="#" class="table_icon d-2-none" data-toggle="popover" data-placement="auto" data-trigger="focus" title="Ayuda" data-content="El tipo de pedido de un elemento es la forma en que se hará el pedido del material (Barra, Planchuela, Hierro Ángulo, etc...). <a href='/help/order_types' target='_blank' >Más información...</a>"><img src="/images/helpIcon.png" alt="Ayuda" title="Ayuda" class="inline_icon pl-1 opacity-70 align-top"></a>
		{!! Form::open(['url' => '/storeorder_type']) !!}
				...
				<tr>
					<td>
						<div class="custom-control custom-checkbox">
							{{Form::hidden('d_ext',0)}}
							{!! Form::checkbox('d_ext', 1 ?? old('d_ext'), false, array_merge(['class' => 'custom-control-input'], ['id' => 'd_ext'], ['value' => 1])) !!}
							{!! Form::Label('d_ext', 'Diámetro exterior', array_merge(['class' => 'custom-control-label'], ['onclick' => 'enableDisable("d_ext")'])) !!}
						</div>
						<div class="custom-control custom-checkbox">
							{{Form::hidden('d_int',0)}}
							{!! Form::checkbox('d_int', 1 ?? old('d_int'), false, array_merge(['class' => 'custom-control-input'], ['id' => 'd_int'], ['value' => 1])) !!}
					...
					<td>
						<div class="custom-control custom-checkbox">
							...
							{!! Form::checkbox('side_a', 1 ?? old('side_a'), false, array_merge(['class' => 'custom-control-input'], ['id' => 'side_a'], ['value' => 1])) !!}
							{!! Form::Label('side_a', 'Lado A', array_merge(['class' => 'custom-control-label'], ['onclick' => 'enableDisable("side_a")'])) !!}
						</div>
						<div class="custom-control custom-checkbox">
							{{Form::hidden('side_b',0)}}
							{!! Form::checkbox('side_b', 1 ?? old('side_b'), false, array_merge(['class' => 'custom-control-input'], ['id' => 'side_b'], ['value' => 1])) !!}
					...
					<td>
						<div class="custom-control custom-checkbox">
							{{Form::hidden('large',0)}}
							{!! Form::checkbox('large', 1 ?? old('large'), false, array_merge(['class' => 'custom-control-input'], ['id' => 'large'], ['value' => 1])) !!}
							{!! Form::Label('large', 'Largo', array_merge(['class' => 'custom-control-label'], ['onclick' => 'enableDisable("large")'])) !!}
						</div>
						<div class="custom-control custom-checkbox">
							{{Form::hidden('width',0)}}
							{!! Form::checkbox('width', 1 ?? old('width'), false, array_merge(['class' => 'custom-control-input'], ['id' => 'width'], ['value' => 1])) !!}
					...
					<td>
						<div class="custom-control custom-checkbox">
							...
							{!! Form::checkbox('thickness', 1 ?? old('thickness'), false, array_merge(['class' => 'custom-control-input'], ['id' => 'thickness'], ['value' => 1])) !!}
		...
		{!! Form::submit('Añadir tipo de pedido', array_merge(['class' => 'btn btn-primary'], ['onclick' => 'checkSubmit(event)'])) !!}
		@if ($errors->any())
